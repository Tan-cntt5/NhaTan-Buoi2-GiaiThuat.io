#nguon: https://www.hiepsiit.com/detail/ctdl/ctdl-va-giai-thuat/cai-dat-hang-doi-queue-bang-danh-sach-lien-ket
cai dat
...
int main(){
  ...
  menu(q);
  cout<<"\n---------------------------------\n";
  cout<<"Chương trình này được đang tại hiepsiit.com";
}
